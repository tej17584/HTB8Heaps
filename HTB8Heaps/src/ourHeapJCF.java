...
public class ourHeapJCF<E> {
     ...
     *
     * @return El paciente con mayor prioridad si lo hay, y si no regresa un
     * mensaje diciendo que no hay pacientes
     */
    ...
    /**
     * Llama al siguiente paciente y lo atiende sacandolo de la cola y mostrando
     * su nombre para saber que fue atendido
     *
